...
// VERZIA: V83 - INDUSTRIAL SHIELD COMPLETE (DEFINITIVNA VERZIA S FIXOM UKLADANIA A EMI)
...
// ====================================================================================
//tvari sa že uklada hodnoty s web ale po odpojený su preč 
#include <WiFi.h>
...
<div class="container">
  ...
  <div class="card" style="overflow-x:auto;">
    ...
    <h4>Nastavenie vonkajsieho tlacidlo (Kanal 1)</h4>
...
// FIX: Kompletne vycistena a opravena funkcia od neexistujucich prvkov, ktore rusili odosielanie požiadavky
const saveRow = (i) => {
  lockoutCounter = 5;
